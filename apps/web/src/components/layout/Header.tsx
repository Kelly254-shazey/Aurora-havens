  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-[88px]">
            ...
            <Link href="/" className="flex items-center gap-3 group flex-shrink-0">
              ...
              <div className="hidden sm:block">
                <span className="font-display font-bold text-xl text-white block leading-tight tracking-tight">
                  Aurora Havens
                </span>
                <span className="text-[10px] text-gold-400/60 tracking-[0.25em] uppercase font-semibold">
                  Building Prosperity
                </span>
              </div>
            </Link>
      ...
      >
        ...
        >
          {/* Mobile header */}
          <div className="flex items-center justify-between px-6 h-[88px] border-b border-white/[0.06]">
