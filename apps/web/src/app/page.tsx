    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center bg-dark-900 overflow-hidden overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            {/* Stats Grid */}
            <div className="mt-8 lg:mt-0 lg:animate-slide-up">
              <div className="relative">
                <div className="absolute -inset-4 bg-gold-500/5 rounded-3xl blur-xl" />
                <div className="relative grid grid-cols-2 gap-4">
                  {[
                    { icon: Building2, value: '500+', label: 'Properties', delay: '0ms' },
                    { icon: Users, value: '10K+', label: 'Happy Clients', delay: '100ms' },
                    { icon: Heart, value: '50K+', label: 'Lives Changed', delay: '200ms' },
                    { icon: TrendingUp, value: '18%', label: 'Avg. ROI', delay: '300ms' },
                  ].map((stat) => (
                    <div
                      key={stat.label}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {[
              ...
              <div key={index} className="group text-center p-6 sm:p-8 rounded-2xl border border-gray-200 shadow-sm hover:border-gold-500/30 hover:shadow-xl hover:shadow-gold-500/5 transition-all duration-500">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-8">
            {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-lg shadow-black/5 border border-gray-100 hover:border-gold-500/20 transition-all duration-300"
              >
