        ...
        <section key={index} className={`py-16 sm:py-20 lg:py-24 ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
          <div id={program.title.toLowerCase().replace(/\s+/g, '-')} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="relative overflow-hidden rounded-2xl bg-dark-900">
               ...
               <div className="mt-8 grid sm:grid-cols-2 gap-4 sm:gap-8 items-start">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                  <h4 className="font-display font-semibold text-dark-900 text-sm mb-4 uppercase tracking-wider">
                    What We Do
                  </h4>
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            {SUPPORT_WAYS.map((item, index) => (
              <div key={index} className="group bg-white rounded-2xl p-8 border border-gray-100 text-center hover:border-foundation-hot/30 hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                ...
                <h3 className="font-display font-semibold text-xl text-dark-900 mb-3">
                  {item.title}
                </h3>
