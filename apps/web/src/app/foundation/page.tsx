...
export const metadata: Metadata = {
  title: 'Foundation',
  description: 'Discover Aurora Havens Foundation — community development programs including healthcare, education, feeding programs, and women empowerment across Africa.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-8">
            {STATS.map((stat, index) => (
              <div key={index} className="text-center group p-4 sm:p-6 rounded-2xl border border-gray-100 hover:border-foundation-hot/30 hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                ...
                <div className="text-xl sm:text-2xl lg:text-3xl font-display font-bold text-dark-900 mb-1 whitespace-nowrap">{stat.value}</div>
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            {PROGRAMS.map((program, index) => (
              <div key={index} className="group bg-white rounded-2xl p-8 border border-gray-100 hover:border-foundation-hot/30 hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                ...
                <h3 className="font-display font-semibold text-xl text-dark-900 mb-2">{program.title}</h3>
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-3 gap-4 sm:gap-8">
            {STORIES.map((story, index) => (
              <div key={index} className="group bg-white rounded-2xl p-8 border border-foundation-baby/30 hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-foundation-baby/20">
                  ...
                  <div>
                    <div className="font-display font-semibold text-dark-900 text-sm">{story.name}</div>
