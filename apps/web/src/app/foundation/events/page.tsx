          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            {UPCOMING_EVENTS.map((event, index) => (
              <div key={index} className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:border-foundation-hot/30 hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                <div className={`relative h-48 bg-gradient-to-br ${event.gradient} flex items-center justify-center`}>
                  ...
                  <div className="absolute top-4 left-4 bg-white rounded-xl px-3 py-2 shadow-lg text-center">
                    ...
                    <div className="font-display text-2xl font-bold text-dark-900 leading-none mt-1">{event.date.day}</div>
                  </div>
                ...
                <div className="p-6">
                  <h3 className="font-display font-semibold text-xl text-dark-900 mb-2 group-hover:text-foundation-hot transition-colors">
                    {event.title}
                  </h3>
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-3 gap-4 sm:gap-8">
            {PAST_EVENTS.map((event, index) => (
              <div key={index} className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-foundation-hot/5 transition-all duration-500">
                <div className={`relative h-32 bg-gradient-to-br ${event.gradient} flex items-center justify-center`}>
                  ...
                  <div className="relative bg-white rounded-xl px-3 py-2 shadow-lg text-center">
                    <div className="text-xs font-bold text-foundation-hot leading-none">{event.date.month}</div>
                    <div className="font-display text-xl font-bold text-dark-900 leading-none mt-0.5">{event.date.day}</div>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="font-display font-semibold text-dark-900 mb-2">{event.title}</h3>
