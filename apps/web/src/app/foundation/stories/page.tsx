             ...
             <div className="grid md:grid-cols-3 gap-4 sm:gap-8 items-start">
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-foundation-baby/20">
                  ...
                  <div>
                    <div className="font-display font-semibold text-dark-900">{FEATURED_STORY.name}</div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                ...
                <div className="font-display font-semibold text-dark-900 text-lg">{FEATURED_STORY.program}</div>
