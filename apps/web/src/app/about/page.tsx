...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about Aurora Havens — our mission, vision, and team dedicated to real estate excellence and community development across Africa.',
};

const TEAM = [
  { name: 'Amara Okonkwo', initials: 'AO', role: 'CEO & Founder', color: 'from-gold-400 to-gold-600' },
  { name: 'David Mwangi', initials: 'DM', role: 'Chief Operations Officer', color: 'from-dark-700 to-dark-900' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-dark-900 rounded-2xl overflow-hidden border border-gold-500/20 p-10">
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {VALUES.map((value, index) => (
              <div key={index} className="group text-center p-8 rounded-2xl bg-white border border-gray-100 hover:border-gold-500/30 hover:shadow-xl hover:shadow-gold-500/5 transition-all duration-500">
          ...
          <div className="text-center mb-16">
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            {TEAM.map((member, index) => (
              <div key={index} className="group bg-white rounded-2xl p-8 border border-gray-100 hover:border-gold-500/30 hover:shadow-xl hover:shadow-gold-500/5 transition-all duration-500 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            {MILESTONES.map((milestone, index) => (
              <div key={index} className={`relative flex items-start sm:items-center mb-8 sm:mb-12 pl-12 sm:pl-0 ${index % 2 === 0 ? 'sm:flex-row' : 'sm:flex-row-reverse'}`}>
