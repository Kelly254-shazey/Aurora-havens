      ...
      <section className="min-h-screen bg-white pt-32 pb-16">
        <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
            ...
            <h1 className="font-display text-3xl font-bold text-navy-500 mb-3">
              Donation Successful
            </h1>
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-left space-y-4 mb-8">
              <div className="flex justify-between">
                ...
                <span className="text-navy-500 text-sm font-medium font-mono">{txRef}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-navy-500 text-sm font-medium">{causeTitle}</span>
              </div>
              <div className="flex justify-between">
      ...
      <section className="pt-32 pb-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            ...
            <h1 className="font-display text-4xl lg:text-5xl font-bold text-navy-500 mb-4">
      ...
      {step === 'processing' ? (
        <section className="pb-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
              ...
              <h2 className="font-display text-xl font-bold text-navy-500 mb-2">Processing...</h2>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          ...
          <section className="mb-12">
            <ScrollReveal>
              <h2 className="text-lg font-semibold text-navy-500 mb-4">Choose a Cause</h2>
            </ScrollReveal>
            <StaggerContainer className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3" staggerDelay={0.06}>
              {CAUSES.map((cause) => {
                ...
                return (
                  <StaggerItem key={cause.id}>
                    <button
                      ...
                      className={`text-left rounded-xl p-5 border-2 transition-all cursor-pointer w-full ${
                        isActive
                    ...
                    >
                      ...
                      <p className="font-semibold text-navy-500 text-sm">{cause.title}</p>
          ...
          <section className="mb-12">
            <ScrollReveal>
              <h2 className="text-lg font-semibold text-navy-500 mb-4">Select Amount</h2>
            </ScrollReveal>
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-3 mb-4">
              {AMOUNTS.map((amount) => (
                <button
                  ...
                  className={`py-3 px-4 rounded-xl border-2 font-display font-bold text-navy-500 transition-all ${
            ...
            <div className="relative max-w-xs">
              ...
              <input
                ...
                className="w-full pl-14 pr-4 py-3 rounded-xl border border-gray-200 focus:border-gold-500 focus:ring-2 focus:ring-gold-500/20 outline-none transition-all text-navy-500"
              />
            </div>
            {errors.amount && (
          ...
          <section className="mb-12">
            <ScrollReveal>
              <h2 className="text-lg font-semibold text-navy-500 mb-4">Payment Method</h2>
            </ScrollReveal>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {PAYMENT_METHODS.map((method) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-navy-500">{method.label}</span>
                </button>
              ))}
            </div>
            {errors.method && (
          ...
          {selectedMethod && (
            <section className="mb-12">
              <ScrollReveal>
                <h2 className="text-lg font-semibold text-navy-500 mb-4">Payment Details</h2>
              </ScrollReveal>
                ...
                {selectedMethod === 'mpesa' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gold-500 focus:ring-2 focus:ring-gold-500/20 outline-none transition-all text-navy-500"
                    />
                ...
                {selectedMethod === 'card' && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-navy-500 mb-1">CVC</label>
                        <input
                          type="text"
                          placeholder="123"
                          value={formData.cvc || ''}
